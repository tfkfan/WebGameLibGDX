...
public interface ISkillSpriteFactory {
    ...
    public abstract <A extends GameAnimation, T extends SkillSprite> T createSingleSkillSprite(final Class<A> animationClass);
    public abstract <A extends GameAnimation, T extends SkillSprite> T createFallingSkillSprite(final Class<A> animationClass);
}
