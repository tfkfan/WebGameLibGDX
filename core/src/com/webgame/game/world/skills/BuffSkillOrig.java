...
public abstract class BuffSkillOrig<T extends SkillSprite> extends SkillOrig<T> {
    final int w = 100;
    final int h = 100;

    protected Vector2 vel = new Vector2(0, 0);

    public BuffSkillOrig(SpriteBatch batch, Texture spriteTexture, Integer numFrames) throws Exception {
